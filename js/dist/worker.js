(() => {
  ...
  var require_mp4box_all_min = __commonJS({
    "src/third_party/mp4boxjs/mp4box.all.min.js"(exports) {
      var Log = function() {
        ...
        return { setLogLevel: function(t) {
          r = t == this.debug ? 1 : t == this.info ? 2 : t == this.warn ? 3 : (this.error, 4);
        }, debug: function(t, e) {
          void 0 === console.debug && (console.debug = console.log), r <= 1 && console.debug("[" + Log.getDurationString(/* @__PURE__ */ new Date() - i, 1e3) + "]", "[" + t + "]", e);
        }, log: function(t, e) {
          this.debug(t.msg);
        }, info: function(t, e) {
          r <= 2 && console.info("[" + Log.getDurationString(/* @__PURE__ */ new Date() - i, 1e3) + "]", "[" + t + "]", e);
        }, warn: function(t, e) {
          r <= 3 && console.warn("[" + Log.getDurationString(/* @__PURE__ */ new Date() - i, 1e3) + "]", "[" + t + "]", e);
        }, error: function(t, e) {
          r <= 4 && console.error("[" + Log.getDurationString(/* @__PURE__ */ new Date() - i, 1e3) + "]", "[" + t + "]", e);
        } };
      }();
      ...
      DataStream2.prototype = {}, DataStream2.prototype.getPosition = function() {
      ...
      }, DataStream2.BIG_ENDIAN = false, DataStream2.LITTLE_ENDIAN = true, DataStream2.prototype._byteLength = 0, Object.defineProperty(DataStream2.prototype, "byteLength", { get: function() {
        return this._byteLength - this._byteOffset;
      } }), Object.defineProperty(DataStream2.prototype, "buffer", { get: function() {
        return this._trimAlloc(), this._buffer;
      }, set: function(t) {
        this._buffer = t, this._dataView = new DataView(this._buffer, this._byteOffset), this._byteLength = this._buffer.byteLength;
      } }), Object.defineProperty(DataStream2.prototype, "byteOffset", { get: function() {
      ...
      } }), Object.defineProperty(DataStream2.prototype, "dataView", { get: function() {
        ...
        return DataStream2.memcpy(i.buffer, 0, this.buffer, this.byteOffset + this.position, t * i.BYTES_PER_ELEMENT), DataStream2.arrayToNative(i, null == e ? this.endianness : e), this.position += i.byteLength, i;
        ...
        return DataStream2.memcpy(e.buffer, 0, this.buffer, this.byteOffset + this.position, t * e.BYTES_PER_ELEMENT), this.position += e.byteLength, e;
      ...
      DataStream2.prototype.readInt64 = function() {
      ...
      }, DataStream2.prototype._dynamicSize = true, Object.defineProperty(DataStream2.prototype, "dynamicSize", { get: function() {
        ...
        if (this._realloc(4 * t.length), t instanceof Int32Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          DataStream2.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapInt32Array(t.length, e);
        else
        ...
        if (this._realloc(2 * t.length), t instanceof Int16Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          DataStream2.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapInt16Array(t.length, e);
        else
          for (var i = 0; i < t.length; i++)
        ...
        if (this._realloc(+t.length), t instanceof Int8Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          DataStream2.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapInt8Array(t.length);
        else
        ...
        if (this._realloc(4 * t.length), t instanceof Uint32Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          DataStream2.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapUint32Array(t.length, e);
        else
          for (var i = 0; i < t.length; i++)
        ...
        if (this._realloc(2 * t.length), t instanceof Uint16Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          DataStream2.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapUint16Array(t.length, e);
        else
          for (var i = 0; i < t.length; i++)
        ...
        if (this._realloc(+t.length), t instanceof Uint8Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          DataStream2.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapUint8Array(t.length);
        else
          for (var e = 0; e < t.length; e++)
            this.writeUint8(t[e]);
        ...
        if (this._realloc(8 * t.length), t instanceof Float64Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          DataStream2.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapFloat64Array(t.length, e);
        else
          for (var i = 0; i < t.length; i++)
        ...
        if (this._realloc(4 * t.length), t instanceof Float32Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          DataStream2.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapFloat32Array(t.length, e);
        else
          for (var i = 0; i < t.length; i++)
      ...
      MultiBufferStream.prototype = new DataStream2(new ArrayBuffer(), 0, DataStream2.BIG_ENDIAN), MultiBufferStream.prototype.initialized = function() {
        var t;
        return -1 < this.bufferIndex || (0 < this.buffers.length ? 0 === (t = this.buffers[0]).fileStart ? (this.buffer = t, this.bufferIndex = 0, Log.debug("MultiBufferStream", "Stream ready for parsing"), true) : (Log.warn("MultiBufferStream", "The first buffer should have a fileStart of 0"), this.logBufferLevel(), false) : (Log.warn("MultiBufferStream", "No buffer to start parsing from"), this.logBufferLevel(), false));
        ...
        if (this.bufferIndex + 1 < this.buffers.length) {
          ...
          return this.buffers[this.bufferIndex] = ArrayBuffer.concat(this.buffer, t), this.buffer = this.buffers[this.bufferIndex], this.buffers.splice(this.bufferIndex + 1, 1), this.buffer.usedBytes = i, this.buffer.fileStart = r, Log.debug("ISOFile", "Concatenating buffer for box parsing (length: " + e + "->" + this.buffer.byteLength + ")"), true;
        }
        return false;
        ...
        return -1 !== i ? (this.buffer = this.buffers[i], this.bufferIndex = i, this.position = t - this.buffer.fileStart, Log.debug("MultiBufferStream", "Repositioning parser at buffer position: " + this.position), true) : (Log.debug("MultiBufferStream", "Position " + t + " not found in buffered data"), false);
      ...
      var MPEG4DescriptorParser = function() {
        ...
        return this.parseOneDescriptor = function(t) {
          ...
          return i += 127 & e, Log.debug("MPEG4DescriptorParser", "Found " + (s[r2] || "Descriptor " + r2) + ", size " + i + " at position " + t.getPosition()), (r2 = new (s[r2] ? a[s[r2]] : a.Descriptor)(i)).parse(t), r2;
      ...
      var BoxParser = { ERR_INVALID_DATA: -1, ERR_NOT_ENOUGH_DATA: 0, OK: 1, BASIC_BOXES: ["mdat", "idat", "free", "skip", "meco", "strk"], FULL_BOXES: ["hmhd", "nmhd", "iods", "xml ", "bxml", "ipro", "mere"], CONTAINER_BOXES: [["moov", ["trak", "pssh"]], ["trak"], ["edts"], ["mdia"], ["minf"], ["dinf"], ["stbl", ["sgpd", "sbgp"]], ["mvex", ["trex"]], ["moof", ["traf"]], ["traf", ["trun", "sgpd", "sbgp"]], ["vttc"], ["tref"], ["iref"], ["mfra", ["tfra"]], ["meco"], ["hnti"], ["hinf"], ["strk"], ["strd"], ["sinf"], ["rinf"], ["schi"], ["trgr"], ["udta", ["kind"]], ["iprp", ["ipma"]], ["ipco"]], boxCodes: [], fullBoxCodes: [], containerBoxCodes: [], sampleEntryCodes: {}, sampleGroupEntryCodes: [], trackGroupTypes: [], UUIDBoxes: {}, UUIDs: [], initialize: function() {
      ...
      BoxParser.initialize(), BoxParser.TKHD_FLAG_ENABLED = 1, BoxParser.TKHD_FLAG_IN_MOVIE = 2, BoxParser.TKHD_FLAG_IN_PREVIEW = 4, BoxParser.TFHD_FLAG_BASE_DATA_OFFSET = 1, BoxParser.TFHD_FLAG_SAMPLE_DESC = 2, BoxParser.TFHD_FLAG_SAMPLE_DUR = 8, BoxParser.TFHD_FLAG_SAMPLE_SIZE = 16, BoxParser.TFHD_FLAG_SAMPLE_FLAGS = 32, BoxParser.TFHD_FLAG_DUR_EMPTY = 65536, BoxParser.TFHD_FLAG_DEFAULT_BASE_IS_MOOF = 131072, BoxParser.TRUN_FLAGS_DATA_OFFSET = 1, BoxParser.TRUN_FLAGS_FIRST_FLAG = 4, BoxParser.TRUN_FLAGS_DURATION = 256, BoxParser.TRUN_FLAGS_SIZE = 512, BoxParser.TRUN_FLAGS_FLAGS = 1024, BoxParser.TRUN_FLAGS_CTS_OFFSET = 2048, BoxParser.Box.prototype.add = function(t) {
        ...
        for (; t.getPosition() < this.start + this.size; ) {
          if ((e = BoxParser.parseOneBox(t, false, this.size - (t.getPosition() - this.start))).code !== BoxParser.OK)
            return;
          var e, i = e.box;
        ...
        void 0 !== MPEG4DescriptorParser && (t = new MPEG4DescriptorParser(), this.esd = t.parseOneDescriptor(new DataStream2(e.buffer, 0, DataStream2.BIG_ENDIAN)));
        ...
        for (this.references = []; t.getPosition() < this.start + this.size; ) {
          if ((e = BoxParser.parseOneBox(t, true, this.size - (t.getPosition() - this.start))).code !== BoxParser.OK)
            return;
        ...
        for (this.entries = [], r = t.readUint32(), e = 1; e <= r; e++) {
          if ((i = BoxParser.parseOneBox(t, true, this.size - (t.getPosition() - this.start))).code !== BoxParser.OK)
            return;
        ...
        for (this.stereo_indication_type = t.readString(e), this.boxes = []; t.getPosition() < this.start + this.size; ) {
          if ((i = BoxParser.parseOneBox(t, false, this.size - (t.getPosition() - this.start))).code !== BoxParser.OK)
            return;
        ...
        for (this.track_ID = t.readUint32(), this.boxes = []; t.getPosition() < this.start + this.size; ) {
          if (ret = BoxParser.parseOneBox(t, false, this.size - (t.getPosition() - this.start)), ret.code !== BoxParser.OK)
            return;
      ...
      }), BoxParser.createUUIDBox("a5d40b30e81411ddba2f0800200c9a66", true, false, function(t) {
        this.LiveServerManifest = t.readString(this.size - this.hdr_size).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;");
      }), BoxParser.createUUIDBox("d08a4f1810f34a82b6c832d8aba183d3", true, false, function(t) {
        this.system_id = BoxParser.parseHex16(t);
        var e = t.readUint32();
        0 < e && (this.data = t.readUint8Array(e));
      }), BoxParser.createUUIDBox("a2394f525a9b4f14a2446c427c648df4", true, false), BoxParser.createUUIDBox("8974dbce7be74c5184f97148f9882554", true, false, function(t) {
        this.default_AlgorithmID = t.readUint24(), this.default_IV_size = t.readUint8(), this.default_KID = BoxParser.parseHex16(t);
      }), BoxParser.createUUIDBox("d4807ef2ca3946958e5426cb9e46a79f", true, false, function(t) {
      ...
      }), BoxParser.createUUIDBox("6d1d9b0542d544e680e2141daff757b2", true, false, function(t) {
        ...
        var e, i = { held_bits: void 0, num_held_bits: 0, stream_read_1_bytes: function(t2) {
        ...
        if (this.hvcC) {
          ...
          var s = false, a = "";
          for (r = 5; 0 <= r; r--)
            (this.hvcC.general_constraint_indicator[r] || s) && (a = "." + BoxParser.decimalToHex(this.hvcC.general_constraint_indicator[r], 0) + a, s = true);
          t += a;
        }
        return t;
      ...
      ISOFile.prototype.setSegmentOptions = function(t, e, i) {
              ...
              for (o = n, t = 0; t < o.trafs.length; t++) {
                for (h = o.trafs[t], d = this.getTrackById(h.tfhd.track_id), l = this.getTrexById(h.tfhd.track_id), e = h.tfhd.flags & BoxParser.TFHD_FLAG_SAMPLE_DESC ? h.tfhd.default_sample_description_index : l ? l.default_sample_description_index : 1, i = h.tfhd.flags & BoxParser.TFHD_FLAG_SAMPLE_DUR ? h.tfhd.default_sample_duration : l ? l.default_sample_duration : 0, r = h.tfhd.flags & BoxParser.TFHD_FLAG_SAMPLE_SIZE ? h.tfhd.default_sample_size : l ? l.default_sample_size : 0, s = h.tfhd.flags & BoxParser.TFHD_FLAG_SAMPLE_FLAGS ? h.tfhd.default_sample_flags : l ? l.default_sample_flags : 0, (h.sample_number = 0) < h.sbgps.length && ISOFile.initSampleGroups(d, h, h.sbgps, d.mdia.minf.stbl.sgpds, h.sgpds), y = 0; y < h.truns.length; y++)
                  for (var f = h.truns[y], u = 0; u < f.sample_count; u++) {
                    ...
                    p.offset = 0 === y && 0 === u ? m ? g + f.data_offset : g : a, a = p.offset + p.size, (0 < h.sbgps.length || 0 < h.sgpds.length || 0 < d.mdia.minf.stbl.sbgps.length || 0 < d.mdia.minf.stbl.sgpds.length) && ISOFile.setSampleGroupProperties(d, p, p.number_in_traf, h.sample_groups_info);
                  }
                if (h.subs) {
        ...
        for (; ; ) {
          ...
          if (r.size - r.alreadyRead <= s)
            return Log.debug("ISOFile", "Getting sample #" + e + " data (alreadyRead: " + r.alreadyRead + " offset: " + (r.offset + r.alreadyRead - i.fileStart) + " read size: " + (r.size - r.alreadyRead) + " full size: " + r.size + ")"), DataStream2.memcpy(r.data.buffer, r.alreadyRead, i, r.offset + r.alreadyRead - i.fileStart, r.size - r.alreadyRead), i.usedBytes += r.size - r.alreadyRead, this.stream.logBufferLevel(), r.alreadyRead = r.size, r;
          if (0 == s)
            return null;
          Log.debug("ISOFile", "Getting sample #" + e + " partial data (alreadyRead: " + r.alreadyRead + " offset: " + (r.offset + r.alreadyRead - i.fileStart) + " read size: " + s + " full size: " + r.size + ")"), DataStream2.memcpy(r.data.buffer, r.alreadyRead, i, r.offset + r.alreadyRead - i.fileStart, s), r.alreadyRead += s, i.usedBytes += s, this.stream.logBufferLevel();
        }
        ...
        for (var r = 0; r < i.extents.length; r++) {
          ...
          if (s.alreadyRead !== s.length) {
            ...
            if (!(s.length - s.alreadyRead <= a))
              return Log.debug("ISOFile", "Getting item #" + t + " extent #" + r + " partial data (alreadyRead: " + s.alreadyRead + " offset: " + (s.offset + s.alreadyRead - e.fileStart) + " read size: " + a + " full extent size: " + s.length + " full item size: " + i.size + ")"), DataStream2.memcpy(i.data.buffer, i.alreadyRead, e, s.offset + s.alreadyRead - e.fileStart, a), s.alreadyRead += a, i.alreadyRead += a, e.usedBytes += a, this.stream.logBufferLevel(), null;
            Log.debug("ISOFile", "Getting item #" + t + " extent #" + r + " data (alreadyRead: " + s.alreadyRead + " offset: " + (s.offset + s.alreadyRead - e.fileStart) + " read size: " + (s.length - s.alreadyRead) + " full extent size: " + s.length + " full item size: " + i.size + ")"), DataStream2.memcpy(i.data.buffer, i.alreadyRead, e, s.offset + s.alreadyRead - e.fileStart, s.length - s.alreadyRead), e.usedBytes += s.length - s.alreadyRead, this.stream.logBufferLevel(), i.alreadyRead += s.length - s.alreadyRead, s.alreadyRead = s.length;
          }
        }
      ...
      var MP4Box2 = { createFile: function(t, e) {
        t = void 0 === t || t, e = new ISOFile(e);
        return e.discardMdatData = !t, e;
      } };
      "undefined" != typeof exports && (exports.createFile = MP4Box2.createFile);
    }
  });

  // src/demuxer_mp4.js
  var import_mp4box_all_min = __toESM(require_mp4box_all_min());
  ...
  var MP4Demuxer = class {
    ...
    constructor(uri, { onConfig, onChunk, setStatus: setStatus2 }) {
      ...
      this.#setStatus = setStatus2;
      this.#file = import_mp4box_all_min.default.createFile();
  ...
  function start({ dataUri, rendererName, canvas, sharedArrayBuffer }) {
  ...
  var Canvas2DRenderer = class {
    ...
    draw(frame) {
      ...
      self.postMessage(
        this.#ctx.getImageData(0, 0, frame.displayWidth, frame.displayHeight).data
      );
      frame.close();
    }
  };
