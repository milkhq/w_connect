(() => {
  ...
  // src/third_party/mp4boxjs/mp4box.all.min.js
  var require_mp4box_all_min = __commonJS({
    "src/third_party/mp4boxjs/mp4box.all.min.js"(exports) {
      var Log = function() {
        var i = /* @__PURE__ */ new Date(), r = 4;
        return {
          setLogLevel: function(t) {
            r = t == this.debug ? 1 : t == this.info ? 2 : t == this.warn ? 3 : (this.error, 4);
          },
          debug: function(t, e) {
            void 0 === console.debug && (console.debug = console.log), r <= 1 && console.debug(
              "[" + Log.getDurationString(/* @__PURE__ */ new Date() - i, 1e3) + "]",
              "[" + t + "]",
              e
            );
          },
      ...
      Log.getDurationString = function(t, e) {
        var i;
        function r(t2, e2) {
          for (var i2 = ("" + t2).split("."); i2[0].length < e2; )
            i2[0] = "0" + i2[0];
          return i2.join(".");
        }
      ...
      MP4BoxStream.prototype.getPosition = function() {
        ...
        return this.position = isNaN(t) || !isFinite(t) ? 0 : t, true;
      ...
      var DataStream2 = function(t, e, i) {
        this._byteOffset = e || 0, t instanceof ArrayBuffer ? this.buffer = t : "object" == typeof t ? (this.dataView = t, e && (this._byteOffset += e)) : this.buffer = new ArrayBuffer(t || 0), this.position = 0, this.endianness = null == i ? DataStream2.LITTLE_ENDIAN : i;
      };
      DataStream2.prototype = {}, DataStream2.prototype.getPosition = function() {
        return this.position;
      }, DataStream2.prototype._realloc = function(t) {
      ...
      }, DataStream2.BIG_ENDIAN = false, DataStream2.LITTLE_ENDIAN = true, DataStream2.prototype._byteLength = 0, Object.defineProperty(DataStream2.prototype, "byteLength", {
        get: function() {
      ...
      }, DataStream2.prototype.readInt8Array = function(t) {
      ...
      }, DataStream2.prototype.readUint32Array = function(t, e) {
        t = null == t ? this.byteLength - this.position / 4 : t;
      ...
      }, DataStream2.prototype.readUint16Array = function(t, e) {
        t = null == t ? this.byteLength - this.position / 2 : t;
      ...
      }, DataStream2.prototype.readUint8Array = function(t) {
        t = null == t ? this.byteLength - this.position : t;
      ...
      }, DataStream2.prototype.readFloat64Array = function(t, e) {
      ...
      }, DataStream2.prototype.readFloat32Array = function(t, e) {
        t = null == t ? this.byteLength - this.position / 4 : t;
      ...
      }, DataStream2.prototype.readInt32 = function(t) {
        t = this._dataView.getInt32(this.position, null == t ? this.endianness : t);
        return this.position += 4, t;
      }, DataStream2.prototype.readInt16 = function(t) {
      ...
      }, DataStream2.prototype.readUint32 = function(t) {
        t = this._dataView.getUint32(
          this.position,
          null == t ? this.endianness : t
        );
        return this.position += 4, t;
      }, DataStream2.prototype.readUint16 = function(t) {
        ...
        return this.position += 1, t;
      }, DataStream2.prototype.readFloat32 = function(t) {
        t = this._dataView.getFloat32(
          this.position,
          null == t ? this.endianness : t
        );
        return this.position += 4, t;
      }, DataStream2.prototype.readFloat64 = function(t) {
        t = this._dataView.getFloat64(
          this.position,
          null == t ? this.endianness : t
        );
        return this.position += 8, t;
      }, DataStream2.endianness = 0 < new Int8Array(new Int16Array([1]).buffer)[0], DataStream2.memcpy = function(t, e, i, r, s) {
        e = new Uint8Array(t, e, s), s = new Uint8Array(i, r, s);
        e.set(s);
      }, DataStream2.arrayToNative = function(t, e) {
        return e == this.endianness ? t : this.flipArrayEndianness(t);
      }, DataStream2.nativeToEndian = function(t, e) {
        return this.endianness == e ? t : this.flipArrayEndianness(t);
      }, DataStream2.flipArrayEndianness = function(t) {
        ...
        return t;
      }, DataStream2.prototype.failurePosition = 0, String.fromCharCodeUint8 = function(t) {
        for (var e = [], i = 0; i < t.length; i++)
          e[i] = t[i];
        return String.fromCharCode.apply(null, e);
      }, DataStream2.prototype.readString = function(t, e) {
        return null == e || "ASCII" == e ? String.fromCharCodeUint8.apply(null, [
          this.mapUint8Array(null == t ? this.byteLength - this.position : t)
        ]) : new TextDecoder(e).decode(this.mapUint8Array(t));
      }, DataStream2.prototype.readCString = function(t) {
      ...
      DataStream2.prototype.readInt64 = function() {
      ...
      }, "undefined" != typeof exports && (exports.DataStream = DataStream2), DataStream2.prototype.save = function(t) {
      ...
      }, DataStream2.prototype._dynamicSize = true, Object.defineProperty(DataStream2.prototype, "dynamicSize", {
        get: function() {
      ...
      }), DataStream2.prototype.shift = function(t) {
      ...
      }, DataStream2.prototype.writeInt32Array = function(t, e) {
      ...
      }, DataStream2.prototype.writeInt16Array = function(t, e) {
      ...
      }, DataStream2.prototype.writeInt8Array = function(t) {
        if (this._realloc(+t.length), t instanceof Int8Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          ...
          for (var e = 0; e < t.length; e++)
            this.writeInt8(t[e]);
      }, DataStream2.prototype.writeUint32Array = function(t, e) {
      ...
      }, DataStream2.prototype.writeUint16Array = function(t, e) {
      ...
      }, DataStream2.prototype.writeUint8Array = function(t) {
        if (this._realloc(+t.length), t instanceof Uint8Array && this.byteOffset + this.position % t.BYTES_PER_ELEMENT === 0)
          ...
          for (var e = 0; e < t.length; e++)
            this.writeUint8(t[e]);
      }, DataStream2.prototype.writeFloat64Array = function(t, e) {
      ...
      }, DataStream2.prototype.writeFloat32Array = function(t, e) {
      ...
      }, DataStream2.prototype.writeCString = function(t, e) {
        var i = 0;
        if (null != e) {
      ...
      }, DataStream2.prototype.writeStruct = function(t, e) {
        for (var i = 0; i < t.length; i += 2) {
          var r = t[i + 1];
          this.writeType(r, e[t[i]], e);
        }
      }, DataStream2.prototype.writeType = function(t, e, i) {
        var r;
        ...
        switch ("string" == typeof t && /:/.test(t) && (t = (r = t.split(":"))[0], s = parseInt(r[1])), "string" == typeof t && /,/.test(t) && (t = (r = t.split(","))[0], a = parseInt(r[1])), t) {
          ...
          case "float64":
            ...
            break;
          case "uint16be":
            this.writeUint16(e, DataStream2.BIG_ENDIAN);
            break;
          case "int16be":
            this.writeInt16(e, DataStream2.BIG_ENDIAN);
            break;
          case "uint32be":
            this.writeUint32(e, DataStream2.BIG_ENDIAN);
            break;
          case "int32be":
            this.writeInt32(e, DataStream2.BIG_ENDIAN);
            break;
          case "float32be":
            this.writeFloat32(e, DataStream2.BIG_ENDIAN);
            break;
          case "float64be":
            this.writeFloat64(e, DataStream2.BIG_ENDIAN);
            break;
          case "uint16le":
            this.writeUint16(e, DataStream2.LITTLE_ENDIAN);
            break;
          case "int16le":
            this.writeInt16(e, DataStream2.LITTLE_ENDIAN);
            break;
          case "uint32le":
            this.writeUint32(e, DataStream2.LITTLE_ENDIAN);
            break;
          case "int32le":
            this.writeInt32(e, DataStream2.LITTLE_ENDIAN);
            break;
          case "float32le":
            this.writeFloat32(e, DataStream2.LITTLE_ENDIAN);
            break;
          case "float64le":
            this.writeFloat64(e, DataStream2.LITTLE_ENDIAN);
            break;
          case "cstring":
          ...
          case "u16string":
            ...
            break;
          case "u16stringle":
            this.writeUCS2String(e, DataStream2.LITTLE_ENDIAN, s);
            break;
          case "u16stringbe":
            this.writeUCS2String(e, DataStream2.BIG_ENDIAN, s);
            break;
          default:
            if (3 == t.length) {
      ...
      }, DataStream2.prototype.writeUint64 = function(t) {
        var e = Math.floor(t / MAX_SIZE);
        this.writeUint32(e), this.writeUint32(4294967295 & t);
      }, DataStream2.prototype.writeUint24 = function(t) {
        this.writeUint8((16711680 & t) >> 16), this.writeUint8((65280 & t) >> 8), this.writeUint8(255 & t);
      }, DataStream2.prototype.adjustUint32 = function(t, e) {
        var i = this.position;
        this.seek(t), this.writeUint32(e), this.seek(i);
      }, DataStream2.prototype.mapInt32Array = function(t, e) {
        this._realloc(4 * t);
        var i = new Int32Array(this._buffer, this.byteOffset + this.position, t);
        return DataStream2.arrayToNative(i, null == e ? this.endianness : e), this.position += 4 * t, i;
      }, DataStream2.prototype.mapInt16Array = function(t, e) {
        this._realloc(2 * t);
        var i = new Int16Array(this._buffer, this.byteOffset + this.position, t);
        return DataStream2.arrayToNative(i, null == e ? this.endianness : e), this.position += 2 * t, i;
      }, DataStream2.prototype.mapInt8Array = function(t) {
        this._realloc(+t);
        var e = new Int8Array(this._buffer, this.byteOffset + this.position, t);
        return this.position += +t, e;
      }, DataStream2.prototype.mapUint32Array = function(t, e) {
        this._realloc(4 * t);
        var i = new Uint32Array(this._buffer, this.byteOffset + this.position, t);
        return DataStream2.arrayToNative(i, null == e ? this.endianness : e), this.position += 4 * t, i;
      }, DataStream2.prototype.mapUint16Array = function(t, e) {
        this._realloc(2 * t);
        var i = new Uint16Array(this._buffer, this.byteOffset + this.position, t);
        return DataStream2.arrayToNative(i, null == e ? this.endianness : e), this.position += 2 * t, i;
      }, DataStream2.prototype.mapFloat64Array = function(t, e) {
        this._realloc(8 * t);
        var i = new Float64Array(this._buffer, this.byteOffset + this.position, t);
        return DataStream2.arrayToNative(i, null == e ? this.endianness : e), this.position += 8 * t, i;
      }, DataStream2.prototype.mapFloat32Array = function(t, e) {
        this._realloc(4 * t);
      ...
      MultiBufferStream.prototype = new DataStream2(
        new ArrayBuffer(),
        0,
        DataStream2.BIG_ENDIAN
      ), MultiBufferStream.prototype.initialized = function() {
        var t;
        return -1 < this.bufferIndex || (0 < this.buffers.length ? 0 === (t = this.buffers[0]).fileStart ? (this.buffer = t, this.bufferIndex = 0, Log.debug("MultiBufferStream", "Stream ready for parsing"), true) : (Log.warn(
          "MultiBufferStream",
          "The first buffer should have a fileStart of 0"
        ), this.logBufferLevel(), false) : (Log.warn("MultiBufferStream", "No buffer to start parsing from"), this.logBufferLevel(), false));
        ...
        for (var e = true, i = 0; i < this.buffers.length; i++) {
          ...
          if (t.fileStart <= r.fileStart) {
            if (t.fileStart === r.fileStart) {
              ...
              Log.warn(
                "MultiBufferStream",
                "Buffer (fileStart: " + t.fileStart + " - Length: " + t.byteLength + ") already appended, ignoring"
              );
            } else
              t.fileStart + t.byteLength <= r.fileStart || (t = this.reduceBuffer(t, 0, r.fileStart - t.fileStart)), Log.debug(
                "MultiBufferStream",
                "Appending new buffer (fileStart: " + t.fileStart + " - Length: " + t.byteLength + ")"
              ), this.buffers.splice(i, 0, t), 0 === i && (this.buffer = t);
            e = false;
            break;
          }
        ...
        e && (Log.debug(
          "MultiBufferStream",
          "Appending new buffer (fileStart: " + t.fileStart + " - Length: " + t.byteLength + ")"
        ), this.buffers.push(t), 0 === i && (this.buffer = t));
        ...
        0 === this.buffers.length ? t("MultiBufferStream", "No more buffer in memory") : t(
          "MultiBufferStream",
          this.buffers.length + " stored buffer(s) (" + a + "/" + n + " bytes), continuous ranges: " + s
        );
        ...
        if (this.bufferIndex + 1 < this.buffers.length) {
          ...
          return this.buffers[this.bufferIndex] = ArrayBuffer.concat(this.buffer, t), this.buffer = this.buffers[this.bufferIndex], this.buffers.splice(this.bufferIndex + 1, 1), this.buffer.usedBytes = i, this.buffer.fileStart = r, Log.debug(
            "ISOFile",
        ...
        for (var r = null, s = -1, a = true === t ? 0 : this.bufferIndex; a < this.buffers.length && (r = this.buffers[a]).fileStart <= e; )
          s = a, i && (r.fileStart + r.byteLength <= e ? r.usedBytes = r.byteLength : r.usedBytes = e - r.fileStart, this.logBufferLevel()), a++;
        return -1 !== s && (r = this.buffers[s]).fileStart + r.byteLength >= e ? (Log.debug(
          "MultiBufferStream",
        ...
        return -1 !== i ? (this.buffer = this.buffers[i], this.bufferIndex = i, this.position = t - this.buffer.fileStart, Log.debug(
          "MultiBufferStream",
      ...
      var MPEG4DescriptorParser = function() {
        ...
        return this.parseOneDescriptor = function(t) {
          var e, i = 0, r2 = t.readUint8();
          for (e = t.readUint8(), 0; 128 & e; )
            i = (127 & e) << 7, e = t.readUint8(), 0;
          return i += 127 & e, Log.debug(
            "MPEG4DescriptorParser",
            "Found " + (s[r2] || "Descriptor " + r2) + ", size " + i + " at position " + t.getPosition()
          ), (r2 = new (s[r2] ? a[s[r2]] : a.Descriptor)(i)).parse(t), r2;
      ...
      var BoxParser = {
        ...
        createBoxCtor: function(e, t) {
          BoxParser.boxCodes.push(e), BoxParser[e + "Box"] = function(t2) {
            BoxParser.Box.call(this, e, t2);
        ...
        createContainerBoxCtor: function(e, t, i) {
          BoxParser[e + "Box"] = function(t2) {
            BoxParser.ContainerBox.call(this, e, t2), BoxParser.addSubBoxArrays.call(this, i);
        ...
        createMediaSampleEntryCtor: function(t, e, i) {
          BoxParser.sampleEntryCodes[t] = [], BoxParser[t + "SampleEntry"] = function(t2, e2) {
            BoxParser.SampleEntry.call(this, t2, e2), BoxParser.addSubBoxArrays.call(this, i);
        ...
        createSampleEntryCtor: function(e, i, t, r) {
          BoxParser.sampleEntryCodes[e].push(i), BoxParser[i + "SampleEntry"] = function(t2) {
            BoxParser[e + "SampleEntry"].call(this, i, t2), BoxParser.addSubBoxArrays.call(this, r);
        ...
        createSampleGroupCtor: function(e, t) {
          BoxParser[e + "SampleGroupEntry"] = function(t2) {
            BoxParser.SampleGroupEntry.call(this, e, t2);
        ...
        createTrackGroupCtor: function(e, t) {
          BoxParser[e + "TrackGroupTypeBox"] = function(t2) {
            BoxParser.TrackGroupTypeBox.call(this, e, t2);
      ...
      BoxParser.initialize(), BoxParser.TKHD_FLAG_ENABLED = 1, BoxParser.TKHD_FLAG_IN_MOVIE = 2, BoxParser.TKHD_FLAG_IN_PREVIEW = 4, BoxParser.TFHD_FLAG_BASE_DATA_OFFSET = 1, BoxParser.TFHD_FLAG_SAMPLE_DESC = 2, BoxParser.TFHD_FLAG_SAMPLE_DUR = 8, BoxParser.TFHD_FLAG_SAMPLE_SIZE = 16, BoxParser.TFHD_FLAG_SAMPLE_FLAGS = 32, BoxParser.TFHD_FLAG_DUR_EMPTY = 65536, BoxParser.TFHD_FLAG_DEFAULT_BASE_IS_MOOF = 131072, BoxParser.TRUN_FLAGS_DATA_OFFSET = 1, BoxParser.TRUN_FLAGS_FIRST_FLAG = 4, BoxParser.TRUN_FLAGS_DURATION = 256, BoxParser.TRUN_FLAGS_SIZE = 512, BoxParser.TRUN_FLAGS_FLAGS = 1024, BoxParser.TRUN_FLAGS_CTS_OFFSET = 2048, BoxParser.Box.prototype.add = function(t) {
        ...
        if (1 == o) {
          ...
          if (i)
            ...
            ), r = new BoxParser.Box(h, o), { code: BoxParser.OK, box: r, size: r.size };
        }
        return 0 !== o && o < n ? (Log.error(
          "BoxParser",
          ...
          hdr_size: n,
          start: a
        }) : 0 !== o && a + o > t.getEndPosition() ? (t.seek(a), Log.info(
          "BoxParser",
          ...
          hdr_size: n,
          start: a
        }) : e ? { code: BoxParser.OK, type: h, size: o, hdr_size: n, start: a } : (BoxParser[h + "Box"] ? r = new BoxParser[h + "Box"](o) : "uuid" !== h ? (Log.warn("BoxParser", "Unknown box type: '" + h + "'"), (r = new BoxParser.Box(h, o)).has_unparsed_data = true) : BoxParser.UUIDBoxes[s] ? r = new BoxParser.UUIDBoxes[s](o) : (Log.warn("BoxParser", "Unknown uuid type: '" + s + "'"), (r = new BoxParser.Box(h, o)).uuid = s, r.has_unparsed_data = true), r.hdr_size = n, r.start = a, r.write === BoxParser.Box.prototype.write && "mdat" !== r.type && (Log.info(
          "BoxParser",
          "'" + d + "' box writing not yet implemented, keeping unparsed data in memory for later write"
        ), r.parseDataAndRewind(t)), r.parse(t), (a = t.getPosition() - (r.start + r.size)) < 0 ? (Log.warn(
          "BoxParser",
          "Parsing of box '" + d + "' did not read the entire indicated box data size (missing " + -a + " bytes), seeking forward"
        ), t.seek(r.start + r.size)) : 0 < a && (Log.error(
          "BoxParser",
          "Parsing of box '" + d + "' read " + a + " more bytes than the indicated box data size, seeking backwards"
        ), 0 !== r.size && t.seek(r.start + r.size)), { code: BoxParser.OK, box: r, size: r.size });
        ...
        for (; t.getPosition() < this.start + this.size; ) {
          if ((e = BoxParser.parseOneBox(
            ...
            return;
          var e, i = e.box;
          this.boxes.push(i), this.subBoxNames && -1 != this.subBoxNames.indexOf(i.type) ? this[this.subBoxNames[this.subBoxNames.indexOf(i.type)] + "s"].push(
            i
          ) : this[e = "uuid" !== i.type ? i.type : i.uuid] ? Log.warn(
        ...
        t = [];
        t[0] = this.language >> 10 & 31, t[1] = this.language >> 5 & 31, t[2] = 31 & this.language, this.languageString = String.fromCharCode(
          t[0] + 96,
          t[1] + 96,
          t[2] + 96
        );
        ...
        void 0 !== MPEG4DescriptorParser && (t = new MPEG4DescriptorParser(), this.esd = t.parseOneDescriptor(
          new DataStream2(e.buffer, 0, DataStream2.BIG_ENDIAN)
        ));
        ...
        for (this.references = []; t.getPosition() < this.start + this.size; ) {
          if ((e = BoxParser.parseOneBox(
            ...
            return;
          (e = new (0 === this.version ? BoxParser.SingleItemTypeReferenceBox : BoxParser.SingleItemTypeReferenceBoxLarge)(e.type, e.size, e.hdr_size, e.start)).write === BoxParser.Box.prototype.write && "mdat" !== e.type && (Log.warn(
            "BoxParser",
            e.type + " box writing not yet implemented, keeping unparsed data in memory for later write"
          ), e.parseDataAndRewind(t)), e.parse(t), this.references.push(e);
        }
        ...
        1 & this.flags && (Log.warn(
          "BoxParser",
          "mehd box incorrectly uses flags set to 1, converting version to 1"
        ), this.version = 1), 1 == this.version ? this.fragment_duration = t.readUint64() : this.fragment_duration = t.readUint32();
        ...
        this.grouping_type = t.readString(4), Log.debug(
          "BoxParser",
          "Found Sample Groups of type " + this.grouping_type
        ), 1 === this.version ? this.default_length = t.readUint32() : this.default_length = 0, 2 <= this.version && (this.default_group_description_index = t.readUint32()), this.entries = [];
        for (var e = t.readUint32(), i = 0; i < e; i++) {
          ...
          this.entries.push(r), 1 === this.version && 0 === this.default_length ? r.description_length = t.readUint32() : r.description_length = this.default_length, r.write === BoxParser.SampleGroupEntry.prototype.write && (Log.info(
            "BoxParser",
            "SampleGroup for type " + this.grouping_type + " writing not yet implemented, keeping unparsed data in memory for later write"
          ), r.data = t.readUint8Array(r.description_length), t.position -= r.description_length), r.parse(t);
        }
        ...
        for (this.entries = [], r = t.readUint32(), e = 1; e <= r; e++) {
          if ((i = BoxParser.parseOneBox(
            t,
            true,
            this.size - (t.getPosition() - this.start)
          )).code !== BoxParser.OK)
            return;
          BoxParser[i.type + "SampleEntry"] ? ((s = new BoxParser[i.type + "SampleEntry"](i.size)).hdr_size = i.hdr_size, s.start = i.start) : (Log.warn("BoxParser", "Unknown sample entry type: " + i.type), s = new BoxParser.SampleEntry(i.type, i.size, i.hdr_size, i.start)), s.write === BoxParser.SampleEntry.prototype.write && (Log.info(
            "BoxParser",
            "SampleEntry " + s.type + " box writing not yet implemented, keeping unparsed data in memory for later write"
          ), s.parseDataAndRewind(t)), s.parse(t), this.entries.push(s);
        }
        ...
        if (this.sample_counts = [], this.sample_deltas = [], 0 === this.version)
          for (e = 0; e < r; e++)
            this.sample_counts.push(t.readUint32()), (i = t.readInt32()) < 0 && (Log.warn(
              "BoxParser",
              "File uses negative stts sample delta, using value 1 instead, sync may be lost!"
            ), i = 1), this.sample_deltas.push(i);
        ...
        for (var e; t.getPosition() < this.start + this.size; ) {
          ...
          (e = new BoxParser.TrackReferenceTypeBox(
            ...
            e.hdr_size,
            e.start
          )).write === BoxParser.Box.prototype.write && "mdat" !== e.type && (Log.info(
            "BoxParser",
            "TrackReference " + e.type + " box writing not yet implemented, keeping unparsed data in memory for later write"
          ), e.parseDataAndRewind(t)), e.parse(t), this.boxes.push(e);
        }
      }, BoxParser.createFullBoxCtor("trep", function(t) {
        for (this.track_ID = t.readUint32(), this.boxes = []; t.getPosition() < this.start + this.size; ) {
          if (ret = BoxParser.parseOneBox(
            t,
            false,
            this.size - (t.getPosition() - this.start)
      ...
      ), BoxParser.createUUIDBox("a2394f525a9b4f14a2446c427c648df4", true, false), BoxParser.createUUIDBox(
        ...
        var e, i = {
          held_bits: void 0,
          num_held_bits: 0,
          stream_read_1_bytes: function(t2) {
            this.held_bits = t2.readUint8(), this.num_held_bits = 8;
          },
          stream_read_2_bytes: function(t2) {
            this.held_bits = t2.readUint16(), this.num_held_bits = 16;
          },
          extract_bits: function(t2) {
            var e2 = this.held_bits >> this.num_held_bits - t2 & (1 << t2) - 1;
            return this.num_held_bits -= t2, e2;
          }
        };
        ...
        for (var n = t.readUint8(), o = 0; o < n; o++) {
          var h = [];
          this.nalu_arrays.push(h), i.stream_read_1_bytes(t), h.completeness = i.extract_bits(1), i.extract_bits(2), h.nalu_type = i.extract_bits(5);
          var d = 1;
        ...
        if (this.hvcC) {
          ...
          var s = false, a = "";
          for (r = 5; 0 <= r; r--)
            (this.hvcC.general_constraint_indicator[r] || s) && (a = "." + BoxParser.decimalToHex(
        ...
        if (this.vvcC) {
          ...
          if (this.vvcC.general_constraint_info) {
            var i, r = [], s = 0;
            for (s |= this.vvcC.ptl_frame_only_constraint << 7, s |= this.vvcC.ptl_multilayer_enabled << 6, h = 0; h < this.vvcC.general_constraint_info.length; ++h)
              s |= this.vvcC.general_constraint_info[h] >> 2 & 63, r.push(s), s && (i = h), s = this.vvcC.general_constraint_info[h] >> 2 & 3;
            if (void 0 === i)
              e = ".CA";
            else {
              e = ".C";
        ...
        var t = BoxParser.SampleEntry.prototype.getCodec.call(this), e = this.vpcC.level;
        0 == e && (e = "00");
        ...
        this.size += 8, this.size > MAX_SIZE && (this.size += 8), "uuid" === this.type && (this.size += 16), Log.debug(
          "BoxWriter",
          "Writing box " + this.type + " of size: " + this.size + " at position " + t.getPosition() + (e || "")
        ), this.size > MAX_SIZE ? t.writeUint32(1) : (this.sizePosition = t.getPosition(), t.writeUint32(this.size)), t.writeString(this.type, null, 4), "uuid" === this.type && t.writeUint8Array(this.uuid), this.size > MAX_SIZE && t.writeUint64(this.size);
      }, BoxParser.FullBox.prototype.writeHeader = function(t) {
        this.size += 4, BoxParser.Box.prototype.writeHeader.call(
          this,
          t,
          " v=" + this.version + " f=" + this.flags
        ), t.writeUint8(this.version), t.writeUint24(this.flags);
        ...
        this.writeHeader(t), t.writeUint8Array(this.data), this.size += this.data.length, Log.debug(
          "BoxWriter",
          "Adjusting box " + this.type + " with new size " + this.size
        ), t.adjustUint32(this.sizePosition, this.size);
        ...
        for (var e = 0; e < this.references.length; e++) {
          ...
          t.writeUint32(i.reference_type << 31 | i.referenced_size), t.writeUint32(i.subsegment_duration), t.writeUint32(
      ...
      VTTin4Parser.prototype.parseSample = function(t) {
        for (var e, i = new MP4BoxStream(t.buffer), r = []; !i.isEos(); )
          (e = BoxParser.parseOneBox(i, false)).code === BoxParser.OK && "vttc" === e.box.type && r.push(e.box);
        return r;
      }, VTTin4Parser.prototype.getText = function(t, e, i) {
        function s(t2, e2, i2) {
          return i2 = i2 || "0", (t2 += "").length >= e2 ? t2 : new Array(e2 - t2.length + 1).join(i2) + t2;
        }
        function r(t2) {
          var e2 = Math.floor(t2 / 3600), i2 = Math.floor((t2 - 3600 * e2) / 60), r2 = Math.floor(t2 - 3600 * e2 - 60 * i2), t2 = Math.floor(1e3 * (t2 - 3600 * e2 - 60 * i2 - r2));
          return s(e2, 2) + ":" + s(i2, 2) + ":" + s(r2, 2) + "." + s(t2, 3);
        }
      ...
      XMLSubtitlein4Parser.prototype.parseSample = function(t) {
        ...
        return "undefined" != typeof DOMParser && (i.document = new DOMParser().parseFromString(
          i.documentString,
          "application/xml"
        )), i;
      };
      ...
      ISOFile.prototype.setSegmentOptions = function(t, e, i) {
          ...
          for (; ; )
            if (this.hasIncompleteMdat && this.hasIncompleteMdat()) {
              if (!this.processIncompleteMdat())
                return;
            } else if (this.saveParsePosition && this.saveParsePosition(), (t = BoxParser.parseOneBox(this.stream, false)).code === BoxParser.ERR_NOT_ENOUGH_DATA) {
        ...
        return 0 === t.byteLength ? (Log.warn(
          "ISOFile",
          "Ignoring empty buffer (fileStart: " + t.fileStart + ")"
        ), this.stream.logBufferLevel(), false) : (Log.info(
          "ISOFile",
          "Processing buffer (fileStart: " + t.fileStart + ")"
        ), t.usedBytes = 0, this.stream.insertBuffer(t), this.stream.logBufferLevel(), !!this.stream.initialized() || (Log.warn("ISOFile", "Not ready to start parsing"), false));
      }, ISOFile.prototype.appendBuffer = function(t, e) {
        var i;
        if (this.checkBuffer(t))
          return this.parse(), this.moovStartFound && !this.moovStartSent && (this.moovStartSent = true, this.onMoovStart && this.onMoovStart()), this.moov ? (this.sampleListBuilt || (this.buildSampleLists(), this.sampleListBuilt = true), this.updateSampleLists(), this.onReady && !this.readySent && (this.readySent = true, this.onReady(this.getInfo())), this.processSamples(e), this.nextSeekPosition ? (i = this.nextSeekPosition, this.nextSeekPosition = void 0) : i = this.nextParsePosition, this.stream.getEndFilePositionAfter && (i = this.stream.getEndFilePositionAfter(i))) : i = this.nextParsePosition || 0, this.sidx && this.onSidx && !this.sidxSent && (this.onSidx(this.sidx), this.sidxSent = true), this.meta && (this.flattenItemInfo && !this.itemListBuilt && (this.flattenItemInfo(), this.itemListBuilt = true), this.processItems && this.processItems(this.onItem)), this.stream.cleanBuffers && (Log.info(
            "ISOFile",
            "Done processing buffer (fileStart: " + t.fileStart + ") - next buffer to fetch should have a fileStart position of " + i
          ), this.stream.logBufferLevel(), this.stream.cleanBuffers(), this.stream.logBufferLevel(true), Log.info(
            "ISOFile",
            "Sample data size in memory: " + this.getAllocatedSampleDataSize()
          )), i;
      }, ISOFile.prototype.getInfo = function() {
        var t, e, i, r, s, a, n = {}, o = (/* @__PURE__ */ new Date("1904-01-01T00:00:00Z")).getTime();
        if (this.moov)
          for (n.hasMoov = true, n.duration = this.moov.mvhd.duration, n.timescale = this.moov.mvhd.timescale, n.isFragmented = null != this.moov.mvex, n.isFragmented && this.moov.mvex.mehd && (n.fragment_duration = this.moov.mvex.mehd.fragment_duration), n.isProgressive = this.isProgressive, n.hasIOD = null != this.moov.iods, n.brands = [], n.brands.push(this.ftyp.major_brand), n.brands = n.brands.concat(this.ftyp.compatible_brands), n.created = new Date(o + 1e3 * this.moov.mvhd.creation_time), n.modified = new Date(o + 1e3 * this.moov.mvhd.modification_time), n.tracks = [], n.audioTracks = [], n.videoTracks = [], n.subtitleTracks = [], n.metadataTracks = [], n.hintTracks = [], n.otherTracks = [], t = 0; t < this.moov.traks.length; t++) {
            if (a = (i = this.moov.traks[t]).mdia.minf.stbl.stsd.entries[0], r = {}, n.tracks.push(r), r.id = i.tkhd.track_id, r.name = i.mdia.hdlr.name, r.references = [], i.tref)
              for (e = 0; e < i.tref.boxes.length; e++)
                s = {}, r.references.push(s), s.type = i.tref.boxes[e].type, s.track_ids = i.tref.boxes[e].track_ids;
        ...
        if (n.mime = "", n.hasMoov && n.tracks) {
          for (n.videoTracks && 0 < n.videoTracks.length ? n.mime += 'video/mp4; codecs="' : n.audioTracks && 0 < n.audioTracks.length ? n.mime += 'audio/mp4; codecs="' : n.mime += 'application/mp4; codecs="', t = 0; t < n.tracks.length; t++)
          ...
          if (this.isFragmentationInitialized && null !== this.onSegment)
            for (e = 0; e < this.fragmentedTracks.length; e++)
              for (var i = this.fragmentedTracks[e], r = i.trak; r.nextSample < r.samples.length && this.sampleProcessingStarted; ) {
                ...
                if (!s)
                  break;
                if (i.segmentStream = s, r.nextSample++, (r.nextSample % i.nb_samples == 0 || t || r.nextSample >= r.samples.length) && (Log.info(
                  "ISOFile",
                  "Sending fragmented data on track #" + i.id + " for samples [" + Math.max(0, r.nextSample - i.nb_samples) + "," + (r.nextSample - 1) + "]"
                ), Log.info(
                  "ISOFile",
                  "Sample data size in memory: " + this.getAllocatedSampleDataSize()
                ...
                ), i.segmentStream = null, i !== this.fragmentedTracks[e]))
                  break;
              }
          if (null !== this.onSamples)
            for (e = 0; e < this.extractedTracks.length; e++) {
              ...
              for (r = a.trak; r.nextSample < r.samples.length && this.sampleProcessingStarted; ) {
                ...
                if (!n)
                  break;
                if (r.nextSample++, a.samples.push(n), (r.nextSample % a.nb_samples == 0 || r.nextSample >= r.samples.length) && (Log.debug(
                  "ISOFile",
                  "Sending samples on track #" + a.id + " for sample " + r.nextSample
                ), this.onSamples && this.onSamples(a.id, a.user, a.samples), a.samples = [], a !== this.extractedTracks[e]))
                  break;
              }
            }
        }
      }, ISOFile.prototype.getBox = function(t) {
        t = this.getBoxes(t, true);
        ...
        Log.info(
          "ISOFile",
          "Track #" + t + " released samples up to " + e + " (released size: " + i + ", remaining: " + this.samplesDataSize + ")"
        ), r.lastValidSample = e;
        ...
        Log.info("ISOFile", "Flushing remaining samples"), this.updateSampleLists(), this.processSamples(true), this.stream.cleanBuffers(), this.stream.logBufferLevel(true);
        ...
        for (e && (h = o), t = i.samples[h].cts, i.nextSample = h; i.samples[h].alreadyRead === i.samples[h].size && i.samples[h + 1]; )
          h++;
        return a = i.samples[h].offset + i.samples[h].alreadyRead, Log.info(
          "ISOFile",
          "Seeking to " + (e ? "RAP" : "") + " sample #" + i.nextSample + " on track " + i.tkhd.track_id + ", time " + Log.getDurationString(t, n) + " and offset: " + a
        ), { offset: a, time: t / n };
        ...
        if (this.moov) {
          ...
          return Log.info(
            "ISOFile",
            "Seeking at time " + Log.getDurationString(a.time, 1) + " needs a buffer with a fileStart position of " + a.offset
          ), a.offset === 1 / 0 ? a = { offset: this.nextParsePosition, time: 0 } : a.offset = this.stream.getEndFilePositionAfter(a.offset), Log.info(
            "ISOFile",
        ...
        return true;
      }, "undefined" != typeof exports && (exports.ISOFile = ISOFile), ISOFile.prototype.lastBoxStartPosition = 0, ISOFile.prototype.parsingMdat = null, ISOFile.prototype.nextParsePosition = 0, ISOFile.prototype.discardMdatData = false, ISOFile.prototype.processIncompleteBox = function(t) {
        var e;
        return "mdat" === t.type ? (e = new BoxParser[t.type + "Box"](t.size), this.parsingMdat = e, this.boxes.push(e), this.mdats.push(e), e.start = t.start, e.hdr_size = t.hdr_size, this.stream.addUsedBytes(e.hdr_size), this.lastBoxStartPosition = e.start + e.size, this.stream.seek(e.start + e.size, false, this.discardMdatData) ? !(this.parsingMdat = null) : (this.moovStartFound ? this.nextParsePosition = this.stream.findEndContiguousBuf() : this.nextParsePosition = e.start + e.size, false)) : ("moov" === t.type && (this.moovStartFound = true, 0 === this.mdats.length && (this.isProgressive = true)), !!this.stream.mergeNextBuffer && this.stream.mergeNextBuffer() ? (this.nextParsePosition = this.stream.getEndPosition(), true) : (!t.type || this.moovStartFound ? this.nextParsePosition = this.stream.getEndPosition() : this.nextParsePosition = this.stream.getPosition() + t.size, false));
      }, ISOFile.prototype.hasIncompleteMdat = function() {
        return null !== this.parsingMdat;
      }, ISOFile.prototype.processIncompleteMdat = function() {
        var t = this.parsingMdat;
        return this.stream.seek(t.start + t.size, false, this.discardMdatData) ? (Log.debug("ISOFile", "Found 'mdat' end in buffered data"), !(this.parsingMdat = null)) : (this.nextParsePosition = this.stream.findEndContiguousBuf(), false);
        ...
        this.moov.mvhd.next_track_id = e.id + 1, i.add("tkhd").set(
          "flags",
          BoxParser.TKHD_FLAG_ENABLED | BoxParser.TKHD_FLAG_IN_MOVIE | BoxParser.TKHD_FLAG_IN_PREVIEW
        ).set("creation_time", 0).set("modification_time", 0).set("track_id", e.id).set("duration", e.duration || 0).set("layer", e.layer || 0).set("alternate_group", 0).set("volume", 1).set("matrix", [0, 0, 0, 0, 0, 0, 0, 0, 0]).set("width", e.width << 16).set("height", e.height << 16);
        t = i.add("mdia");
        ...
        if (void 0 !== BoxParser[e.type + "SampleEntry"]) {
          ...
          e.description && s.addBox(e.description), e.description_boxes && e.description_boxes.forEach(function(t2) {
            s.addBox(t2);
          }), r.add("dinf").add("dref").addEntry(new BoxParser["url Box"]().set("flags", 1));
          t = r.add("stbl");
          return t.add("stsd").addEntry(s), t.add("stts").set("sample_counts", []).set("sample_deltas", []), t.add("stsc").set("first_chunk", []).set("samples_per_chunk", []).set("sample_description_index", []), t.add("stco").set("chunk_offsets", []), t.add("stsz").set("sample_sizes", []), this.moov.mvex.add("trex").set("track_id", e.id).set(
            "default_sample_description_index",
            e.default_sample_description_index || 1
          ).set("default_sample_duration", e.default_sample_duration || 0).set("default_sample_size", e.default_sample_size || 0).set("default_sample_flags", e.default_sample_flags || 0), this.buildTrakSampleLists(i), e.id;
        }
      }, BoxParser.Box.prototype.computeSize = function(t) {
        t = t || new DataStream2();
        t.endianness = DataStream2.BIG_ENDIAN, this.write(t);
      }, ISOFile.prototype.addSample = function(t, e, i) {
        var r = i || {}, i = {}, t = this.getTrackById(t);
        if (null !== t) {
          i.number = t.samples.length, i.track_id = t.tkhd.track_id, i.timescale = t.mdia.mdhd.timescale, i.description_index = r.sample_description_index ? r.sample_description_index - 1 : 0, i.description = t.mdia.minf.stbl.stsd.entries[i.description_index], i.data = e, i.size = e.byteLength, i.alreadyRead = i.size, i.duration = r.duration || 1, i.cts = r.cts || 0, i.dts = r.dts || 0, i.is_sync = r.is_sync || false, i.is_leading = r.is_leading || 0, i.depends_on = r.depends_on || 0, i.is_depended_on = r.is_depended_on || 0, i.has_redundancy = r.has_redundancy || 0, i.degradation_priority = r.degradation_priority || 0, i.offset = 0, i.subsamples = r.subsamples, t.samples.push(i), t.samples_size += i.size, t.samples_duration += i.duration, t.first_dts || (t.first_dts = r.dts), this.processSamples();
        ...
        return r.add("tfhd").set("track_id", t.track_id).set("flags", BoxParser.TFHD_FLAG_DEFAULT_BASE_IS_MOOF), r.add("tfdt").set("baseMediaDecodeTime", t.dts - (s.first_dts || 0)), r.add("trun").set(
          "flags",
          BoxParser.TRUN_FLAGS_DATA_OFFSET | BoxParser.TRUN_FLAGS_DURATION | BoxParser.TRUN_FLAGS_SIZE | BoxParser.TRUN_FLAGS_FLAGS | BoxParser.TRUN_FLAGS_CTS_OFFSET
        ...
        var a, n, o, h;
        function d(t2, e2, i2) {
          this.grouping_type = t2, this.grouping_type_parameter = e2, this.sbgp = i2, this.last_sample_in_run = -1, this.entry_index = -1;
        }
        for (e && (e.sample_groups_info = []), t.sample_groups_info || (t.sample_groups_info = []), n = 0; n < i.length; n++) {
          for (h = i[n].grouping_type + "/" + i[n].grouping_type_parameter, o = new d(i[n].grouping_type, i[n].grouping_type_parameter, i[n]), e && (e.sample_groups_info[h] = o), t.sample_groups_info[h] || (t.sample_groups_info[h] = o), a = 0; a < r.length; a++)
            r[a].grouping_type === i[n].grouping_type && (o.description = r[a], o.description.used = true);
          if (s)
            for (a = 0; a < s.length; a++)
              s[a].grouping_type === i[n].grouping_type && (o.fragment_description = s[a], o.fragment_description.used = true, o.is_fragment = true);
        }
        if (e) {
          if (s)
            for (n = 0; n < s.length; n++)
              !s[n].used && 2 <= s[n].version && (h = s[n].grouping_type + "/0", (o = new d(s[n].grouping_type, 0)).is_fragment = true, e.sample_groups_info[h] || (e.sample_groups_info[h] = o));
        } else
          ...
          for (; this.lastMoofIndex < this.moofs.length; )
            if (n = this.moofs[this.lastMoofIndex], this.lastMoofIndex++, "moof" == n.type)
              for (o = n, t = 0; t < o.trafs.length; t++) {
                ...
                if (h.subs) {
                  d.has_fragment_subsamples = true;
        ...
        if (r.data) {
          ...
          r.data = new Uint8Array(r.size), r.alreadyRead = 0, this.samplesDataSize += r.size, Log.debug(
            "ISOFile",
            "Allocating sample #" + e + " on track #" + t.tkhd.track_id + " of size " + r.size + " (total: " + this.samplesDataSize + ")"
          );
        for (; ; ) {
          var s = this.stream.findPosition(true, r.offset + r.alreadyRead, false);
          if (!(-1 < s))
            return null;
          ...
          if (r.size - r.alreadyRead <= s)
            return Log.debug(
              "ISOFile",
              "Getting sample #" + e + " data (alreadyRead: " + r.alreadyRead + " offset: " + (r.offset + r.alreadyRead - i.fileStart) + " read size: " + (r.size - r.alreadyRead) + " full size: " + r.size + ")"
            ), DataStream2.memcpy(
              r.data.buffer,
              r.alreadyRead,
              i,
            ...
            ), i.usedBytes += r.size - r.alreadyRead, this.stream.logBufferLevel(), r.alreadyRead = r.size, r;
          if (0 == s)
            return null;
          Log.debug(
            "ISOFile",
            "Getting sample #" + e + " partial data (alreadyRead: " + r.alreadyRead + " offset: " + (r.offset + r.alreadyRead - i.fileStart) + " read size: " + s + " full size: " + r.size + ")"
          ), DataStream2.memcpy(
            r.data.buffer,
            r.alreadyRead,
            i,
            r.offset + r.alreadyRead - i.fileStart,
            s
          ), r.alreadyRead += s, i.usedBytes += s, this.stream.logBufferLevel();
        }
        ...
        if (null != e && void 0 !== e.hdlr && void 0 !== e.iinf) {
          ...
          if (e.iloc)
            for (h = 0; h < e.iloc.items.length; h++) {
              ...
              switch (0 !== i.data_reference_index && (Log.warn(
                "Item storage with reference to other files: not supported"
              ), r.source = e.dinf.boxes[i.data_reference_index - 1]), i.construction_method) {
                case 0:
                  break;
                case 1:
                case 2:
          ...
          if (e.pitm && (t[e.pitm.item_id].primary = true), e.iref)
        ...
        if (!(i = this.items[t]).data && i.size)
          i.data = new Uint8Array(i.size), i.alreadyRead = 0, this.itemsDataSize += i.size, Log.debug(
            "ISOFile",
        ...
        for (var r = 0; r < i.extents.length; r++) {
          ...
          if (s.alreadyRead !== s.length) {
            var a = this.stream.findPosition(true, s.offset + s.alreadyRead, false);
            if (!(-1 < a))
              return null;
            ...
            if (!(s.length - s.alreadyRead <= a))
              return Log.debug(
                "ISOFile",
                "Getting item #" + t + " extent #" + r + " partial data (alreadyRead: " + s.alreadyRead + " offset: " + (s.offset + s.alreadyRead - e.fileStart) + " read size: " + a + " full extent size: " + s.length + " full item size: " + i.size + ")"
              ), DataStream2.memcpy(
                i.data.buffer,
                i.alreadyRead,
                e,
                ...
                a
              ), s.alreadyRead += a, i.alreadyRead += a, e.usedBytes += a, this.stream.logBufferLevel(), null;
            Log.debug(
              "ISOFile",
              "Getting item #" + t + " extent #" + r + " data (alreadyRead: " + s.alreadyRead + " offset: " + (s.offset + s.alreadyRead - e.fileStart) + " read size: " + (s.length - s.alreadyRead) + " full extent size: " + s.length + " full item size: " + i.size + ")"
            ), DataStream2.memcpy(
              i.data.buffer,
              i.alreadyRead,
              e,
            ...
            ), e.usedBytes += s.length - s.alreadyRead, this.stream.logBufferLevel(), i.alreadyRead += s.length - s.alreadyRead, s.alreadyRead = s.length;
          }
        }
        ...
        if (null == t)
          return t = r.samples[e], this.nextSeekPosition ? this.nextSeekPosition = Math.min(
            t.offset + t.alreadyRead,
            this.nextSeekPosition
          ) : this.nextSeekPosition = r.samples[e].offset + t.alreadyRead, null;
        e = i || new DataStream2();
        e.endianness = DataStream2.BIG_ENDIAN;
        i = this.createSingleSampleMoof(t);
        i.write(e), i.trafs[0].truns[0].data_offset = i.size + 8, Log.debug(
          "MP4Box",
        ...
        var a = new DataStream2();
        a.endianness = DataStream2.BIG_ENDIAN, t.write(a);
        var n = e.add("mvex");
        ...
        var e = new DataStream2();
        e.endianness = DataStream2.BIG_ENDIAN, this.write(e), e.save(t);
      }, ISOFile.prototype.getBuffer = function() {
        var t = new DataStream2();
        return t.endianness = DataStream2.BIG_ENDIAN, this.write(t), t.buffer;
      }, ISOFile.prototype.initializeSegmentation = function() {
        var t, e, i, r;
        for (null === this.onSegment && Log.warn("MP4Box", "No segmentation callback set!"), this.isFragmentationInitialized || (this.isFragmentationInitialized = true, this.nextMoofNumber = 0, this.resetTables()), e = [], t = 0; t < this.fragmentedTracks.length; t++) {
          var s = new BoxParser.moovBox();
          s.mvhd = this.moov.mvhd, s.boxes.push(s.mvhd), i = this.getTrackById(this.fragmentedTracks[t].id), s.boxes.push(i), s.traks.push(i), (r = {}).id = i.tkhd.track_id, r.user = this.fragmentedTracks[t].user, r.buffer = ISOFile.writeInitializationSegment(
            this.ftyp,
            s,
  ...
  // src/demuxer.mjs
  var import_mp4box_all_min = __toESM(require_mp4box_all_min(), 1);
  var MP4FileSink = class {
    #setStatus = null;
    #file = null;
    #offset = 0;
    constructor(file, setStatus2) {
      this.#file = file;
      this.#setStatus = setStatus2;
    }
    write(chunk) {
  ...
  var MP4Demuxer = class {
    ...
    #setStatus = null;
    #file = null;
    constructor(uri, { onConfig, onChunk, setStatus: setStatus2 }) {
      this.#onConfig = onConfig;
      this.#onChunk = onChunk;
      this.#setStatus = setStatus2;
      this.#file = (0, import_mp4box_all_min.createFile)();
      this.#file.onError = (error) => setStatus2("demux", error);
      this.#file.onReady = this.#onReady.bind(this);
      this.#file.onSamples = this.#onSamples.bind(this);
      const fileSink = new MP4FileSink(this.#file, setStatus2);
    ...
    #description(track) {
      ...
      for (const entry of trak.mdia.minf.stbl.stsd.entries) {
        ...
        if (box2) {
          const stream = new import_mp4box_all_min.DataStream(void 0, 0, import_mp4box_all_min.DataStream.BIG_ENDIAN);
          box2.write(stream);
